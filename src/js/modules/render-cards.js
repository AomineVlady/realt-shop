...
import { cardsList, cardsWrapper, priceTransform, dateTransform, getCardContentData, clearHTMLItem,checkFavoriteCard } from './common.js'
...
const getCardsElements = (card) => {
  return `<li class="results__item product" id = "${card.card_id}">
        <button class="product__favourite fav-add${card.favorite ? " fav-add--active" : ""}" type="button" aria-label="Добавить в избранное">
